    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-5xl mx-auto">
            ...
            <?php if (isset($success)): ?>
                <div class="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded-lg mb-6" data-aos="fade-up"
                    role="alert">
            ...
            <form action="" method="POST" enctype="multipart/form-data" class="space-y-6 md:space-y-8">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-4 md:p-6 transform transition-all duration-300 hover:shadow-2xl"
                    ...
                    <div class="space-y-4">
                        <div class="flex flex-col items-center">
                            <div
                                class="relative w-full h-48 md:h-64 lg:h-80 mb-4 rounded-xl overflow-hidden border-2 border-dashed border-gray-300 hover:border-blue-500 transition-colors duration-300 group">
                            ...
                            <input type="file" name="background" id="background" accept="image/*" class="hidden"
                                onchange="previewImage(this, 'backgroundPreview')">
                            <button type="button" onclick="document.getElementById('background').click()"
                            ...
                            <p class="text-sm text-gray-500 mt-2 text-center">Format yang didukung: JPG, JPEG, PNG.
                                Ukuran yang disarankan: 1920x1080px</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-xl p-4 md:p-6 transform transition-all duration-300 hover:shadow-2xl"
                    ...
                    <div class="space-y-4">
                        <div class="flex flex-col items-center">
                            <div
                                class="relative w-32 h-32 md:w-48 md:h-48 mb-4 rounded-xl overflow-hidden border-2 border-dashed border-gray-300 hover:border-blue-500 transition-colors duration-300 group">
                                <img id="logoPreview"
                            ...
                            <p class="text-sm text-gray-500 mt-2 text-center">Format yang didukung: JPG, JPEG, PNG, GIF
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-xl p-4 md:p-6 transform transition-all duration-300 hover:shadow-2xl"
                    ...
                    <div class="space-y-4">
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input type="text" name="default_password" id="default_password" required
                            ...
                            <p class="text-sm text-gray-500 mt-1">
                                Password ini akan digunakan sebagai password default untuk user baru yang ditambahkan
                                melalui import Excel atau penambahan manual.
                            </p>
                        </div>
                    </div>
                </div>
