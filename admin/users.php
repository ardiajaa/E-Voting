                ...
                <form action="" method="GET" class="flex gap-2">
                    <div class="relative flex-1">
                        ...
                        <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>"
                            placeholder="Cari berdasarkan NIS, nama, kelas, atau absen..." class="search-input">
                        <?php if (!empty($search)): ?>
            ...
            <div class="table-container">
                                ...
                                <tr class="table-row">
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="edit-user.php?id=<?php echo $user['id']; ?>" class="edit-btn" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="?delete=<?php echo $user['id']; ?>" class="delete-btn" title="Hapus"
                ...
                <div class="table-footer">
                    ...
                    <div class="info-text">
                        ...
                        <?php echo min($offset + $show_entries, $total_records); ?> of <?php echo $total_records; ?>
                        entries
                    </div>
                    ...
                    <div class="pagination">
                        <?php if ($page > 1): ?>
                            <a href="?page=1<?php echo !empty($search) ? '&search=' . urlencode($search) : ''; ?><?php echo $show_entries != 5 ? '&show=' . $show_entries : ''; ?>"
                                title="First Page" class="pagination-btn">
                            ...
                            <a href="?page=<?php echo $page - 1; ?><?php echo !empty($search) ? '&search=' . urlencode($search) : ''; ?><?php echo $show_entries != 5 ? '&show=' . $show_entries : ''; ?>"
                                title="Previous Page" class="pagination-btn">
                        ...
                        <?php if ($page < $total_pages): ?>
                            <a href="?page=<?php echo $page + 1; ?><?php echo !empty($search) ? '&search=' . urlencode($search) : ''; ?><?php echo $show_entries != 5 ? '&show=' . $show_entries : ''; ?>"
                                title="Next Page" class="pagination-btn">
                            ...
                            <a href="?page=<?php echo $total_pages; ?><?php echo !empty($search) ? '&search=' . urlencode($search) : ''; ?><?php echo $show_entries != 5 ? '&show=' . $show_entries : ''; ?>"
                                title="Last Page" class="pagination-btn">
